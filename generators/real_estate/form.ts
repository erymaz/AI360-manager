...
export function getFormSchema() {
  return [
    ...
    },
    {
      formFieldType: FormFieldType.NumberDropdown,
      label: {
        "en-US": "Floor of the apartment",
        "en-UK": "Floor of the apartment",
    ...
    divider,
    {
      ...
      label: {
        "en-US": "Living room style",
        "en-UK": "Living room style",
        es: "Estilo de sala de estar",
        de: "Wohnzimmerstil",
      },
      value: "",
