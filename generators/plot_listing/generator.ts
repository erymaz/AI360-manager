...
const PARAM = {
  model: "gpt-35-turbo",
  system_message: "You are a real estate plot marketing expert.",
  temperature: 0,
  top_p: 1.0,
};
...
const sectionGroups = [
  ["address", "condition", "type", "landarea", "min_lot_size", "usage"],
  ["available_from", "total_price", "price_per_sq_meter", "commission"],
...
export const buildPrompt = (
  ...
  let prompt = `Write a plot listing description. It should describe the features in a clear and informative manner, while also using emotive language to create a sense of exclusivity and prestige.

The task is to craft a detailed listing description for plot/land having ${
    paragraphCount - 1
  } paragraphs:\n\n`;
