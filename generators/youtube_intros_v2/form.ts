...
export function getFormSchema() {
  return [
    ...
    },
    {
      ...
      required: true,
      placeholder: {
        "en-US": "Stuck into writer's block ? wAIpify is for you",
        es: "\u00bfAtrapado en el bloqueo del escritor? wAIpify es para ti",
        "de":
          "Stecken Sie in einer Schreibblockade fest? wAIpify ist f\u00fcr Sie",
      },
    },
    {
      formFieldType: FormFieldType.Textarea,
