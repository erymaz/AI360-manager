...
-- AlterTable
ALTER TABLE `business_impact` ADD COLUMN `strategic_value` VARCHAR(50) NULL,
...
-- AlterTable
ALTER TABLE `entries` ADD COLUMN `model_ids` VARCHAR(500) NULL,
    MODIFY `winner_solution_id` VARCHAR(500) NULL,
    MODIFY `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP;
