/*
  ...
  - Added the required column `reference` to the `entries` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `entries` ADD COLUMN `reference` VARCHAR(100) NOT NULL,
