...
-- AlterTable
ALTER TABLE `categories` ADD COLUMN `industry_id` VARCHAR(100) NOT NULL, MODIFY `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
-- DropTable
DROP TABLE `industries_to_categories`;
