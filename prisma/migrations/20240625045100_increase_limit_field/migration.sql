...
-- AlterTable
ALTER TABLE `cases` CHANGE COLUMN `name` `name` VARCHAR(500), MODIFY `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
-- AlterTable
ALTER TABLE `opportunities` CHANGE COLUMN `name` `name` VARCHAR(500), MODIFY `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
-- AlterTable
ALTER TABLE `tasks` CHANGE COLUMN `name` `name` VARCHAR(500), MODIFY `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP;
